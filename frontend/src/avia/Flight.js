...
function Flight({flight: initialFlight, airLine: initialAirline, onAddClick}) {
    ...
    const handleSave = () => {
        ...
        fetch(`http://localhost:8080/api/flight/${flight.id}`, {
            ...
            body: JSON.stringify({ departure_date: updatedDepartureDate, departure_time: updatedDepartureTime, arrival_date: updatedArrivalDate, arrival_time: updatedArrivalTime, ticket_price: updatedPrice }),
        })
            .then(response => {
                if (response.ok) {
                    setFlight(prev => ({ ...prev, departure_date: updatedDepartureDate, departure_time: updatedDepartureTime, arrival_date: updatedArrivalDate, arrival_time: updatedArrivalTime, ticket_price: updatedPrice }));
                }
                else {
                            ...
                            {flight && (
                                <div className="plane-card event-active">
                                    ...
                                    <div className="flight-middle">
                                        <div className="airline-name">{initialAirline}</div>
                                    ...
                                    <div className="myFlight-right">
                                        ...
                                        <div className="button-row">
                                            ...
                                            <button className="pay-button" onClick={handleShowClients}>Clients</button>
                                            {flight.status && (
                                        ...
                                        <div className="bonus-card">
                                            ...
                                            <div className="bonus-control">
                                                <input
                                                    ...
                                                    onChange={(e) =>
                                                        setBonusValues({ ...bonusValues, [item.user.id]: e.target.value })
                                                    }
                                                />
                                                <button className="order-home-button" onClick={() => handleSend(item.user.id)}>
                                                    Send
                                                </button>
                                            </div>
                                        </div>
